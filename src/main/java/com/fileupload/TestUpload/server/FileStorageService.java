...
public class FileStorageService {
    ...
    public void save(MultipartFile multipartFile) {
        ...
        fileStorage.setUploadPath(String.format("/upload_path/%d/%d/%d/%s.%s", now.getYear() + 1900, now.getMonth() + 1, now.getDay(), fileStorage.getHashId(), fileStorage.getFileExtension()));
        repo.save(fileStorage);
